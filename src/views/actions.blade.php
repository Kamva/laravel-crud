{{--
    ...
    buttons, so keep every element of an action on one line, and keep the directives
    glued to the markup as they are: this view's output must not start or end with a newline.
